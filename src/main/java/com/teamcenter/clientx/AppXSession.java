...
public class AppXSession
{
    ...
    public User login(String userId, String password) throws Exception {
    	...
    	LoginResponse out = sessionService.login(userId, password, "", "","", "SoaAppX");
        return out.user;
    }
    
    public User login2(String name, String password) throws Exception
    {
        ...
        SessionService sessionService = SessionService.getService(connection);
            ...
            while (true)
            {
                try
                {
                    ...
                    // *****************************
                    LoginResponse out = sessionService.login(name, password, "", "","", "SoaAppX");
