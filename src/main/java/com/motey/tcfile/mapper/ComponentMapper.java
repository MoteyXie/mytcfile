...
public interface ComponentMapper {
	...
	public ItemComponentContext askItemComponentContext(@Param("puid") String puid, @Param("itemId")String itemId) throws Exception;
	
	public ItemRevisionComponentContext askItemRevisionComponentContext(@Param("puid") String puid) throws Exception;
